...
|------|---|
|구현 기간| **2021.07.23~**|
|구현 내용| - 지역 선택시 토스트 메시지 보이도록 <br> - 지역선택시 화살표 rotate 애니메이션 추가 <br> - 모델 구조 개선 <br> - 글쓰기 플로팅 버튼 개선 <br> - 상품 뷰 다른 상품/추천 상품 마진 개선 <br> - Firebase Realtime Database 연동 <br> - 카테고리 컬렉션/테이블뷰 추가 <br> - 버튼 개선(카테고리, 매너온도, 가격제안하기)|
